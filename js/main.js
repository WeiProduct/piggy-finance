...
const I18N = {
  'en': {
    ...
    shot4: 'Spending by category', shot5: 'Category comparison', shot6: 'Income & expense trends',
    shot7: 'AI bookkeeping assistant', shot8: 'Profile & data',
  ...
  'zh-CN': {
    ...
    shot4: '支出分类占比', shot5: '类别对比图表', shot6: '收支趋势',
    shot7: 'AI 记账助手', shot8: '个人中心与数据',
